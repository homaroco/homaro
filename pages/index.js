  ...
  return (
    <>
      ...
      <header className={styles.header}>
        <svg viewBox="0 0 150 50" width="300" height="100">
          <g transform="translate(-367.5 -468.2)">
            <path fill="#ff1a2d" d="M367.5 468.2h150v50h-150z" />
            <circle cx="413" cy="496.9" r="8.8" fill="#ff1a2d" stroke="#ff1a2d" stroke-linejoin="round" stroke-miterlimit="7.1" stroke-width="9.4" />
      ...
      <main className={styles.main}>
        ...
        <p>{"Homaro has three goals. In order of increasing importance:"}</p>
        <ul>
        ...
        <p>How will we build public trust? By treating people with respect wherever possible. This will involve privacy policies and terms of service that are simple and short, egalitarian employee compensation,<sup><a href="#compensation">[2]</a></sup> , informed-consent op-in-by-default features, truth in advertising, and so on.</p>
        <p>In which markets will we choose to expand? Initially, wherever a software solution offers low-hanging fruit, and wherever consumers are treated with disrespect. This should provide ample opportunity to grow the company. Potential avenues may include open-source voting software, tools or services for local journalism, event planning for charity organizations and other non-profit groups, services to support small farms, developing-world (or developed) microlending, etc.</p>
