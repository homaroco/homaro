  ...
  return (
    <>
      ...
      <main className={styles.main}>
        ...
        <p>There will be checks on the power of these groups. For example, the company president will have veto power over passing policy proposals (which can be overturned by a majority of super-majorities, i.e. two-thirds of the vote in three out of four groups).</p>
        ...
        <h4>What about organized bad actors?</h4>
        <p>Because of the intentional ease to become a stakeholder, Homaro will be uniquely at risk of succumbing to sabotage by organized bad actors. For example, hypothetically, a moderate-to-large competitor could have their workforce become Homaro stakeholders and vote against the company&apos;s interests. If there are a small number of prior stakeholders, then they will be able to obtain super-majorities in half of the governing groups. Give each competitor employee money to purchase a single stock, and they will also have the chance to obtain a (super-)majority in the shareholders group. This will give them a majority of majorities, and their malignant policy proposals will be sent to the president. What if a bad actor is elected president? Given the right circumstances, it is possible to engineer the dissolution of the company. One must ask, however, how probable are these series of events? It is possible for this experiment to be ruined. It is also possible the Earth will soon suffer a cataclysmic natural event. It is possible one may get into a car accident on their way to work tomorrow. Homaro may simply not work, but, just like we cannot fear driving to work because doing so diminishes quality of life, we cannot fear taking a big risk because it might not work out. We believe a company like Homaro is long overdue, and that the potential benefits <i>far</i> outweight the potential risk. As far as the hypothetical is concerned, the structure of Homaro&apos;s government is still a work in progress and there is opportunity for safe-guards to be conceived. Also, we think by the time any moderate-to-large competitor notices us, it will be too late.</p>
        <h4>How do I become a stakeholder?</h4>
        <p>A registration system is currently being developed, but in the meantime you can email <a href="mailto:stakes@homaro.co">stakes at homaro.co</a> and you&apos;ll be be notified of any policy proposals and voting deadlines.</p>
        ...
        <h4>If I&apos;m both a shareholder and stakeholder, in which group will I have a vote?</h4>
        <p>All of them! Your vote on policy proposals will count four times, though with varying weight in each respective group.</p>
        <h4>Where can I reach you?</h4>
        <p>If you have questions, concerns, feedback, or interest in participating in this experiment, please reach out to <a href="mailto:info@homaro.co">info at homaro.co</a>. We can&apos;t do this without the help of others, and we have faith in the kindness of strangers.</p>
