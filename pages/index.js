  ...
  return (
    <>
      ...
      <main className={styles.main}>
        ...
        <p>A registration system is currently being worked on, but in the meantime you can email <a href="mailto:stakes@homaro.co">stakes at homaro.co</a> and you&apos;ll be be notified of any policy proposals and voting deadlines.</p>
